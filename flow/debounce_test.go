...
func testDebounce(t *testing.T, immediate bool) {
	...
	debounced := NewDebounce(100*time.Millisecond, immediate)
...
func BenchmarkDebounce(b *testing.B) {
	...
	debounced := NewDebounce(100*time.Millisecond, false)
...
/*
// TODO: buffer has race condition!!!
