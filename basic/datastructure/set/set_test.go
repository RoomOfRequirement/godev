...
func TestNewIntSet(t *testing.T) {
	...
	var _ basic.Container = (*IntSet)(nil)
	var _ basic.Container = (*FloatSet)(nil)
...
func TestIntSet_Values(t *testing.T) {
	...
	values := basic.GetSortedValues(s, basic.IntComparator, false)
	for i, v := range a {
		if v != values[i].(int) {
			t.Fail()
		}
...
func TestFloatSet_Values(t *testing.T) {
	...
	values := basic.GetSortedValues(s, basic.Float64Comparator, false)
	for i, v := range a {
